...
import { BluffScorePanel } from "../BluffScorePanel";
...
/**
 * Liar's Dice against bots, entirely in the browser.
 *
 * No room, no socket, no account. Shared by the solo route and the older
 * practice URL so there is one implementation rather than two that drift.
 */
export function SoloLiarsDice() {
